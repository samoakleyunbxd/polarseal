...
<div class=\"round_icon bell_notification\" onclick='toggle_notification()'><img src=\"/";
        // line 49
...
";
        // line 52
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, views_embed_view("notifications", "block_1"), "html", null, true);
        echo " 
</div>
</div>
<div class=\"round_icon\"><img class=\"profile_img\" width=\"85\" src=\"";
        // line 55
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user2"] ?? null), "user_picture", [], "any", false, false, true, 55), "entity", [], "any", false, false, true, 55), "uri", [], "any", false, false, true, 55), "value", [], "any", false, false, true, 55), 55, $this->source)), "html", null, true);
        echo "\"></div>
<div class=\"round_icon\"><a href=\"/user/logout\"><img src=\"/";
        // line 56
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["directory"] ?? null), 56, $this->source), "html", null, true);
        echo "/images/icons/exit_icon.png\" alt=\"";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["site_name"] ?? null), 56, $this->source), "html", null, true);
        echo "\"></a></div>
</div>
...
jQuery('#header_notification').toggleClass('show_it');
...
#header_notification .form-item-field-seen-value, #header_notification #edit-submit-notifications--2
{
\tdisplay:none;
}
...
#header_notification 
{
    ...
    padding-top: 0px;
    border-radius: 15px;
    box-shadow: 5px 6px 11px 1px #00000017;
    opacity:0;
    transition:all .5s;
height:0px;
overflow:hidden;
...
";
    ...
    {
        return array (  96 => 56,  92 => 55,  86 => 52,  78 => 49,  72 => 46,  55 => 38,  51 => 37,  44 => 32,  42 => 31,  39 => 30,);
    }
...
<div class=\"round_icon bell_notification\" onclick='toggle_notification()'><img src=\"/{{ directory }}/images/icons/bell_icon.png\" alt=\"{{ site_name }}\">
<div id=\"header_notification\">

{{  drupal_view('notifications', 'block_1') }} 
</div>
</div>
...
", "themes/custom/subtheme/templates/header/block--headertopbar.html.twig", "/home/runcloud/webapps/polarseal/web/themes/custom/subtheme/templates/header/block--headertopbar.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("bamboo_load_currentuser" => 31, "drupal_view" => 52, "file_url" => 55);

        try {
            $this->sandbox->checkSecurity(
                ['set'],
                ['escape'],
                ['bamboo_load_currentuser', 'drupal_view', 'file_url']
            );
