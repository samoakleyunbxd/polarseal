...
<a href=\"";
            // line 171
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("entity.node.canonical", ["node" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "nid", [], "any", false, false, true, 171), "value", [], "any", false, false, true, 171)]), "html", null, true);
            echo "\">
";
            // line 172
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Drupal\twig_tweak\TwigTweakExtension::drupalImage($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "field_image", [], "any", false, false, true, 172), "target_id", [], "any", false, false, true, 172), 172, $this->source), "medium"), "html", null, true);
            echo "
</a>
...
<a href=\"";
            // line 177
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("entity.node.canonical", ["node" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "nid", [], "any", false, false, true, 177), "value", [], "any", false, false, true, 177)]), "html", null, true);
            echo "\"><span class=\"article_title\">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "title", [], "any", false, false, true, 177), "value", [], "any", false, false, true, 177), 177, $this->source));
            echo "</span></a>
<span class=\"article_body\">";
            // line 178
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "body", [], "any", false, false, true, 178), "value", [], "any", false, false, true, 178), 178, $this->source));
            echo "</span>
<p><span class=\"article_date\">";
            // line 179
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "revision_timestamp", [], "any", false, false, true, 179), "value", [], "any", false, false, true, 179), 179, $this->source), "F d,Y"), "html", null, true);
            echo "</span></p>

<div class=\"link_to\">
<a href=\"";
            // line 182
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("entity.node.canonical", ["node" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "nid", [], "any", false, false, true, 182), "value", [], "any", false, false, true, 182)]), "html", null, true);
            echo "\">
link
</a>
</div>
...
";
    ...
    {
        return array (  238 => 195,  219 => 182,  213 => 179,  209 => 178,  203 => 177,  195 => 172,  191 => 171,  182 => 167,  105 => 93,  43 => 34,  39 => 32,);
    }
...
", "themes/custom/subtheme/templates/profile page/content/block--views-block--projects-list-block-1.html.twig", "/home/runcloud/webapps/polarseal/web/themes/custom/subtheme/templates/profile page/content/block--views-block--projects-list-block-1.html.twig");
    ...
    {
        static $tags = array("for" => 167);
        static $filters = array("escape" => 34, "raw" => 177, "date" => 179);
        static $functions = array("attach_library" => 34, "drupal_view" => 93, "path" => 171, "drupal_image" => 172);
