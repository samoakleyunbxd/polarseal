...
<div class=\"round_icon bell_notification\" ><a href=\"/user/";
        // line 49
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user2"] ?? null), "uid", [], "any", false, false, true, 49), "value", [], "any", false, false, true, 49), 49, $this->source), "html", null, true);
        echo "#notifications\"><img src=\"/";
...
<div class=\"round_icon profile\"><a href=\"/\"><img class=\"profile_img\" width=\"85\" src=\"";
        // line 51
...
";
    ...
    {
        return array (  91 => 52,  87 => 51,  78 => 49,  72 => 46,  55 => 38,  51 => 37,  44 => 32,  42 => 31,  39 => 30,);
    }
...
<div class=\"round_icon bell_notification\" ><a href=\"/user/{{user2.uid.value}}#notifications\"><img src=\"/{{ directory }}/images/icons/bell_icon.png\" alt=\"{{ site_name }}\"></a>
</div>
<div class=\"round_icon profile\"><a href=\"/\"><img class=\"profile_img\" width=\"85\" src=\"{{ file_url(user2.user_picture.entity.uri.value) }}\"></a></div>
...
", "themes/custom/subtheme/templates/header/block--headertopbar.html.twig", "/home/runcloud/webapps/polarseal/web/themes/custom/subtheme/templates/header/block--headertopbar.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("bamboo_load_currentuser" => 31, "file_url" => 51);
