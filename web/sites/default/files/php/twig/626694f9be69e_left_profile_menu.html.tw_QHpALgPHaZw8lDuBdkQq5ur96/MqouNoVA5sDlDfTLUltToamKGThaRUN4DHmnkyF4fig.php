...
<li class=\"orders ";
        ...
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["directory"] ?? null), 11, $this->source), "html", null, true);
...
<li class=\"account ";
        // line 47
        if ((($context["path"] ?? null) == ("/user/" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "uid", [], "any", false, false, true, 47), "value", [], "any", false, false, true, 47)))) {
            echo "  active ";
        }
...
.active {
    ...
    -webkit-box-shadow: 0 4px 10px 0 rgb(0 0 0 / 14%)!important;
    box-shadow: 0 4px 10px 0 rgb(0 0 0 / 14%)!important;
}
...
{
    color: #229fb1!important;
    font-weight: 600!important;
}



.left_profile_menu .second_nav p {
    margin-top: 0px;
}
...
";
    ...
    {
        return array (  133 => 47,  108 => 31,  98 => 30,  90 => 27,  82 => 24,  76 => 23,  55 => 11,  50 => 8,  48 => 7,  46 => 6,  39 => 1,);
    }
...
", "themes/custom/subtheme/templates/parts/left_profile_menu.html.twig", "/home/runcloud/webapps/polarseal/web/themes/custom/subtheme/templates/parts/left_profile_menu.html.twig");
    ...
    {
        static $tags = array("set" => 6, "if" => 11);
        static $filters = array("escape" => 11);
        static $functions = array("path" => 6, "bamboo_load_currentuser" => 7);
