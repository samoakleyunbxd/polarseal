...
/**
 * Provides a 'webform_external_media_file' element.
 *
 * @WebformElement(
 *   id = "webform_external_media_file",
 *   label = @Translation("External Media File"),
 ...
 * )
 */
class WebformExternalMediaFile extends WebformManagedFileBase {
